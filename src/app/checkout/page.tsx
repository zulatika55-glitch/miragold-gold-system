...
export default function CheckoutPage() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center px-6 py-16">
      <div className="rounded-2xl border border-amber-900/10 bg-white p-8 shadow-sm">
          ...
          {QUICK_AMOUNTS.map((a) => (
            <button
              ...
              className={`rounded-full border px-4 py-1.5 text-sm transition ${
                amount === a ? "border-amber-900 bg-amber-900 text-white" : "border-zinc-300 text-zinc-700 hover:border-amber-900/40"
              }`}
            >
              RM{a}
            </button>
        ...
        <div className="mt-4 rounded-lg bg-amber-50/50 border border-amber-900/10 p-4 text-sm">
        ...
        <button
          ...
          className="mt-6 w-full rounded-full bg-amber-900 px-6 py-3 font-medium text-white transition hover:bg-amber-800 disabled:opacity-50"
        >
